  ...
  OpenClawCommand? commandForAction(
    ...
    final cmd = switch (actionName) {
      ...
      'update_system' => const OpenClawCommand(
          ...
          displayMessage: 'Updating OpenClaw\u2026 Running `openclaw upgrade`. '
      ...
      'update_api_key' => const OpenClawCommand(
          ...
          displayMessage: 'Please provide your new Anthropic API key. '
      ...
      'clear_agents' => const OpenClawCommand(
          ...
          displayMessage: 'Clearing all agents from the local store. '
      ...
      'system_run' => const OpenClawCommand(
          logMessage:
              'System command requested \u2014 awaiting voice approval',
          ttsMessage:
      ...
      'location_request' => const OpenClawCommand(
          ...
          ttsMessage:
              'Your agent needs your location. Say "Allow" to share.',
          displayMessage:
      ...
      'deactivate_skill' => OpenClawCommand(
          ...
          displayMessage:
              'Deactivated skill "${context['name'] ?? 'unknown'}".',
        ),
